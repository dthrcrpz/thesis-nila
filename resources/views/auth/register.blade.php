...
<html>
    <head>
        ...
        <title>Register | Thesis Book Archiving</title>
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <!-- /.login-logo -->
            @include('includes.validation-errors-not-auth')
            <div class="login-box-body">
                <p class="login-box-msg">Create Account</p>
                <form action="{{ route('register') }}" method="post">
                    @csrf
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" placeholder="Name or Student ID" name="name" required>
                ...
                <br>
                <!-- /.social-auth-links -->
                Already have an account? <a href="/login" class="text-center">Click here to login.</a>
            </div>
            <!-- /.login-box-body -->
        </div>
        <!-- /.login-box -->
