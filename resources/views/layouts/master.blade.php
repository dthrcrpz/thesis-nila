...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu">
                                            ...
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="/cms-assets/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                Support Team
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="/cms-assets/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="/cms-assets/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                Developers
        ...
        <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="/cms-assets/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
    ...
    <section class="col-lg-7 connectedSortable">
        ...
        <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                    <img src="/cms-assets/dist/img/user4-128x128.jpg" alt="user image" class="online">
                    <p class="message">
                        <a href="#" class="name">
                ...
                <!-- chat item -->
                <div class="item">
                    <img src="/cms-assets/dist/img/user3-128x128.jpg" alt="user image" class="offline">
                    <p class="message">
                        <a href="#" class="name">
                ...
                <!-- chat item -->
                <div class="item">
                    <img src="/cms-assets/dist/img/user2-160x160.jpg" alt="user image" class="offline">
                    <p class="message">
                        <a href="#" class="name">
...
<!-- Morris.js charts -->
<script src="/cms-assets/bower_components/raphael/raphael.min.js"></script>
<script src="/cms-assets/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script src="/cms-assets/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="/cms-assets/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="/cms-assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="/cms-assets/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
...
<script src="/cms-assets/dist/js/demo.js"></script>
</body>
</html>